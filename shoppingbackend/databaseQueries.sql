...
VALUES ('Laptop','This is a description for the Laptop Category','CAT_1.png',true);

INSERT INTO category (name,description,image_url,is_active) 
VALUES ('Television','This is a description for the Television Category','CAT_2.png',true);

INSERT INTO category (name,description,image_url,is_active) 
VALUES ('Mobile','This is a description for the Mobile Category','CAT_3.png',true);
...
INSERT INTO user_detail(first_name,last_name,role,enabled,password,email,contact) 
